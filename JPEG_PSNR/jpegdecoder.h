...
public:
    ...
    // Constructor
    jpeg_decoder(std::string filename, double cosine_idct[8][8]);
    // Constructor
    ...
    vector<vector <int> > tCoeff_Y_dou;
    vector<vector <int> > tCoeff_Cb_dou;
    vector<vector <int> > tCoeff_Cr_dou;
    ...
    // set the file name
    void setJPEGFileNameAndStart(std::string filename)
    {
