...
while [ $folder -le $last_folder ]; do {
  while [ $ID -le $last_ID ]; do {
    ...
    # input_path_to_files=/Users/ahamsala/Documents/validation_original/shard-0/1
    ...
    output_path_to_files=/Users/ahamsala/Documents/validation_original_QF/
    txt_path_to_files=/Users/ahamsala/Documents/validation_generated_QF_TXT
    ...
    do
      ...
      # do
        ...
        cmd="./jpeg_tcm $current_jpeg $output_path_to_files $txt_path_to_files 100"
